...
^1.2.3"]
  aws_aws_sdk_php --> guzzlehttp_promises["guzzlehttp/promises...
^2.0"]
  aws_aws_sdk_php --> guzzlehttp_psr7["guzzlehttp/psr7...
^2.4.5"]
  Root --> azuracast_doctrine_entity_normalizer["azuracast/doctrine-entity-normalizer...
3.3.0"]
  azuracast_doctrine_entity_normalizer --> doctrine_inflector["doctrine/inflector...
^2"]
  azuracast_doctrine_entity_normalizer --> doctrine_collections["doctrine/collections...
>1"]
...
>=1"]
  azuracast_nowplaying --> guzzlehttp_guzzle["guzzlehttp/guzzle...
>7"]
